    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=10, null=True, unique=True, verbose_name='用户名')),
                ('headImg', models.ImageField(default='head/default_head.png', upload_to='head/', verbose_name='头像')),
                ('sex', models.CharField(choices=[('male', '男'), ('female', '女'), ('secret', '保密')], default='secret', max_length=6, verbose_name='性别')),
